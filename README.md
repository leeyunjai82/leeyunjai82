...
* [**Hugging Face Profile (@leeyunjai)**](https://huggingface.co/leeyunjai)
* 최신 딥러닝 모델 테스트, 커스텀 모델 파인튜닝, AI 애플리케이션(Spaces) 및 데이터셋을 연구하고 커뮤니티에 공유합니다. <br>*(Actively researching, fine-tuning, and sharing deep learning models, datasets, and AI applications on Hugging Face Spaces.)*

---

### 📊 Overall GitHub Statistics

[![Yunjai's GitHub Stats](https://github-readme-stats.vercel.app/api?username=leeyunjai82&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0D1117)](https://github.com/leeyunjai82)
